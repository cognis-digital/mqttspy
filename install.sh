#!/usr/bin/env sh
# Universal installer for mqttspy. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/mqttspy.git"
echo "Installing mqttspy ..."
